...
public class PlayerActionType extends ActionType {

    /**
     * Construct a new player action type.
     *
     * @param key The key
     * @param resultType The result type
     * @param reversible If action is reversible
     */
    public PlayerActionType(String key, ActionResultType resultType, boolean reversible) {
