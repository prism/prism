...
public class StatusLabelPlaceholderResolver implements IPlaceholderResolver<CommandSender, StatusLabel, Component> {

    @Override
    public @Nullable Map<String, Either<ConclusionValue<? extends Component>, ContinuanceValue<?>>> resolve(
        final String placeholderName,
        final StatusLabel value,
        ...
        return Map.of(
            placeholderName,
            Either.left(ConclusionValue.conclusionValue(Component.translatable(value.translationKey())))
        );
    }
}
