...
@ConflictsWith(value = { BelowParameterParser.class })
public class AboveParameterParser extends IntegerQueryArgumentParser {
     ...
     */
    public AboveParameterParser(MessageService messageService, DefaultsConfiguration defaultsConfiguration) {
        super(messageService, defaultsConfiguration, "above");
    }
    ...
    public boolean parse(
        ...
        if (optionalParameter.isPresent()) {
            ...
            builder.above(optionalParameter.get());
        }
