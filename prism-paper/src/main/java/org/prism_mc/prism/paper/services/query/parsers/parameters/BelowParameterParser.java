...
import org.prism_mc.prism.paper.services.query.parsers.single.IntegerQueryArgumentParser;

@ConflictsWith(value = { AboveParameterParser.class })
public class BelowParameterParser extends IntegerQueryArgumentParser {
     ...
     */
    public BelowParameterParser(MessageService messageService, DefaultsConfiguration defaultsConfiguration) {
        super(messageService, defaultsConfiguration, "below");
    }
    ...
    public boolean parse(
        ...
        if (optionalParameter.isPresent()) {
            ...
            builder.below(optionalParameter.get());
        }
