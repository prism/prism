...
package org.prism_mc.prism.paper.listeners;
...
public class AbstractListener {
     ...
     */
    protected final PaperRecordingService recordingService;
    ...
    protected void recordBlockBreakAction(Block block, Object cause) {
        var action = new PaperBlockAction(PaperActionTypeRegistry.BLOCK_BREAK, block.getState());

        var builder = PaperActivity.builder().action(action).location(block.getLocation()).cause(cause);
    ...
    protected void recordHangingBreak(Entity hanging, Object cause) {
        var action = new PaperEntityAction(PaperActionTypeRegistry.HANGING_BREAK, hanging);

        var builder = PaperActivity.builder().action(action).location(hanging.getLocation()).cause(cause);
        recordingService.addToQueue(builder.build());
    }
    ...
    protected void recordItemDropActivity(Location location, Object cause, ItemStack itemStack, Integer amount) {
        ...
        recordItemActivity(PaperActionTypeRegistry.ITEM_DROP, location, cause, itemStack, amount);
    }
    ...
    protected void recordItemInsertActivity(Location location, Object cause, ItemStack itemStack, int amount) {
        ...
        recordItemActivity(PaperActionTypeRegistry.ITEM_INSERT, location, cause, itemStack, amount);
    }
    ...
    protected void recordItemInsertActivity(Location location, Object cause, ItemStack itemStack) {
        ...
        recordItemActivity(PaperActionTypeRegistry.ITEM_INSERT, location, cause, itemStack, null);
    }
    ...
    protected void recordItemRemoveActivity(Location location, Object cause, ItemStack itemStack) {
        ...
        recordItemActivity(PaperActionTypeRegistry.ITEM_REMOVE, location, cause, itemStack, null);
    }
    ...
    protected void recordItemRemoveActivity(Location location, Object cause, ItemStack itemStack, int amount) {
        ...
        recordItemActivity(PaperActionTypeRegistry.ITEM_REMOVE, location, cause, itemStack, amount);
    }
    ...
    protected void recordItemUseActivity(Location location, Player player, ItemStack itemStack) {
        ...
        recordItemActivity(PaperActionTypeRegistry.ITEM_USE, location, player, itemStack, 1);
    }
