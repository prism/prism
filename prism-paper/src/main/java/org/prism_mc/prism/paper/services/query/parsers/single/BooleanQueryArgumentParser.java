...
public abstract class BooleanQueryArgumentParser extends QueryArgumentSingleValueParser<Boolean> {
     ...
     */
    public BooleanQueryArgumentParser(
        MessageService messageService,
        DefaultsConfiguration defaultsConfiguration,
        String parameter
    ) {
        super(messageService, defaultsConfiguration, parameter, Boolean.class);
    }

    @Override
    protected Optional<Boolean> parseSingleParameter(
        Arguments arguments,
